...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{../Figures/ht_outside_ic}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{../Figures/puf_solution}
...
\paragraph*{}
 ...
 \begin{figure}[h]
 	\centering
 	\includegraphics[width=0.7\linewidth]{../Figures/Hardware_based_encrypt}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{../Figures/tpm}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\linewidth]{../Figures/landing_gear}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{../Figures/anti_tamper}
